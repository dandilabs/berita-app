        ...
        <div class=" row navbar-nav  w-100 justify-content-start px-3 mb-2">
            <div class="col">
              <a class="navbar-brand" href="#"><img class="logo" src="{{asset('assets/img/logo/c.png')}}" alt="logo"></a>
                ...
                <div class="row">
                    <a class="btn btn-outline-custom ml-auto my-3" href="user/login" role="button">Log In</a>
                    <a class="btn btn-custom mx-3 my-3" href="user/register" role="button">Register</a>
                </div>
